...
const aboutPages = [
  { name: 'Nossa História', path: '/about/our-story' },
  { name: 'Sustentabilidade', path: '/about/sustainability' },
  { name: 'Atendimento', path: '/about/customer-care' }
];
  ...
  return (
    <aside className="hidden md:block w-64 sticky top-32 h-fit px-6">
      <nav className="space-y-1">
        <h3 className="text-lg font-light text-foreground mb-6">Sobre</h3>
        {aboutPages.map((page) => (
          <NavLink
            key={page.path}
            to={page.path}
