                ...
                <div className="space-y-6">
                  ...
                  <div className="border-t border-muted-foreground/20 pt-6 mt-8">
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        Usar outro endereço de cobrança
                      </Label>
                    </div>
                  </div>
            ...
            <div className="bg-muted/20 p-8 rounded-none">
              ...
              {!paymentComplete ? (
                <div className="space-y-6">
                  ...
                  >
                    {isProcessing ? "Processando..." : `Finalizar Pedido • R$${total.toLocaleString('pt-BR')}`}
                  </Button>
                </div>
              ) : (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-light text-foreground mb-2">Pedido Confirmado!</h3>
                  <p className="text-muted-foreground">Obrigado pela sua compra. A confirmação do pedido foi enviada para seu e-mail.</p>
                 </div>
               )}
             </div>
            </div>
